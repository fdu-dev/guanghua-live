...
import cn.edu.fudan.anniversary.util.extra.FormFile;
import cn.edu.fudan.anniversary.util.extra.HttpResponse;
...
public class HttpUtils {  
    ...
    public HttpResponse sendPost(String urlString, String content) throws IOException {  
        return this.sendContent(urlString,content, null);  
    }  
     ...
     * @throws IOException 
     */  
    private HttpResponse sendContent(String urlString,String content,Map<String, String> propertys) throws IOException {  
        HttpURLConnection urlConnection = null;  
        ...
        OutputStreamWriter out = new OutputStreamWriter(urlConnection.getOutputStream(), "UTF-8"); // utf-8编码  
        out.append(content);  
        out.flush();  
        out.close();  
